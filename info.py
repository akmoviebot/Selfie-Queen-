...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002495125401'))
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '8183324355').split()]
